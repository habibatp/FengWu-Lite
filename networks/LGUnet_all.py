...
class LGUnet_all(nn.Module):
    def __init__(
        ...
        # 37 niveaux + 5 variables pression + 4 variables surface
        # 1 instant = 4 + 5*37 = 189 canaux
        # 2 instants = 378 canaux
        in_chans=378,
        out_chans=378,
